...
$mname = array("Muharram","Safar","Rabi'ul Awal","Rabi'ul Akhir","Jamadil Awal","Jamadil Akhir","Rajab","Sha'ban","Ramadhan","Shawal","Zul Qaeda","Zul Hijja");
...
size="1"><b> S un</b></font></td>
<td bgcolor="<?PHP echo $defaultwbgcolor ?>" valign="middle" align="center"
width="14%"><font face="<?PHP echo $fontfamily ?>"
size="1"><b> M on</b></font></td>
<td bgcolor="<?PHP echo $defaultwbgcolor ?>" valign="middle" align="center"
width="14%"><font face="<?PHP echo $fontfamily ?>"
size="1"><b> T ue</b></font></td>
<td bgcolor="<?PHP echo $defaultwbgcolor ?>" valign="middle" align="center"
width="14%"><font face="<?PHP echo $fontfamily ?>"
size="1"><b> W ed</b></font></td>
<td bgcolor="<?PHP echo $defaultwbgcolor ?>" valign="middle" align="center"
width="14%"><font face="<?PHP echo $fontfamily ?>"
...
<span class="cell <?php echo ($i == $today) ? 'cellToday' : ''; ?>"><span>
...
<div class="calendar-pagination">
	<a href id="prev" style="left:auto">&laquo;&nbsp;<?php echo $prevText; ?></a>
    <a href id="next" style="right:auto"><?php echo $nextText; ?>&nbsp;&raquo;</a>
</div>
<script>
$(function(){ $
	('.cbData').colorbox({
	...
	$('.calendar-pagination a').click(function(){
		...
		switch(linkID){
			...
			case 'next':
				$.ajax({
					url: 'calendar.php?month=<?php echo $next_month;?>&year=<?php echo $next_year; ?>',
					type: 'post',
					complete: function(){
						FB.XFBML.parse();
					},
